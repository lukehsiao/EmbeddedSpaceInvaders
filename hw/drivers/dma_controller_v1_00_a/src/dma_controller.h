/*****************************************************************************
* Filename:          C:\RH\Lab\Lab8\hw/drivers/dma_controller_v1_00_a/src/dma_controller.h
* Version:           1.00.a
...
#define DMA_CONTROLLER_SLV_REG7_OFFSET (DMA_CONTROLLER_USER_SLV_SPACE_OFFSET + 0x0000001C)
#define DMA_CONTROLLER_SLV_REG8_OFFSET (DMA_CONTROLLER_USER_SLV_SPACE_OFFSET + 0x00000020)
#define DMA_CONTROLLER_SLV_REG9_OFFSET (DMA_CONTROLLER_USER_SLV_SPACE_OFFSET + 0x00000024)
#define DMA_CONTROLLER_SLV_REG10_OFFSET (DMA_CONTROLLER_USER_SLV_SPACE_OFFSET + 0x00000028)
#define DMA_CONTROLLER_SLV_REG11_OFFSET (DMA_CONTROLLER_USER_SLV_SPACE_OFFSET + 0x0000002C)
#define DMA_CONTROLLER_SLV_REG12_OFFSET (DMA_CONTROLLER_USER_SLV_SPACE_OFFSET + 0x00000030)
#define DMA_CONTROLLER_SLV_REG13_OFFSET (DMA_CONTROLLER_USER_SLV_SPACE_OFFSET + 0x00000034)
#define DMA_CONTROLLER_SLV_REG14_OFFSET (DMA_CONTROLLER_USER_SLV_SPACE_OFFSET + 0x00000038)
...
#define DMA_CONTROLLER_mWriteSlaveReg7(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (DMA_CONTROLLER_SLV_REG7_OFFSET) + (RegOffset), (Xuint32)(Value))
#define DMA_CONTROLLER_mWriteSlaveReg8(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (DMA_CONTROLLER_SLV_REG8_OFFSET) + (RegOffset), (Xuint32)(Value))
#define DMA_CONTROLLER_mWriteSlaveReg9(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (DMA_CONTROLLER_SLV_REG9_OFFSET) + (RegOffset), (Xuint32)(Value))
#define DMA_CONTROLLER_mWriteSlaveReg10(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (DMA_CONTROLLER_SLV_REG10_OFFSET) + (RegOffset), (Xuint32)(Value))
#define DMA_CONTROLLER_mWriteSlaveReg11(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (DMA_CONTROLLER_SLV_REG11_OFFSET) + (RegOffset), (Xuint32)(Value))
#define DMA_CONTROLLER_mWriteSlaveReg12(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (DMA_CONTROLLER_SLV_REG12_OFFSET) + (RegOffset), (Xuint32)(Value))
#define DMA_CONTROLLER_mWriteSlaveReg13(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (DMA_CONTROLLER_SLV_REG13_OFFSET) + (RegOffset), (Xuint32)(Value))
#define DMA_CONTROLLER_mWriteSlaveReg14(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (DMA_CONTROLLER_SLV_REG14_OFFSET) + (RegOffset), (Xuint32)(Value))
...
#define DMA_CONTROLLER_mReadSlaveReg7(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (DMA_CONTROLLER_SLV_REG7_OFFSET) + (RegOffset))
#define DMA_CONTROLLER_mReadSlaveReg8(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (DMA_CONTROLLER_SLV_REG8_OFFSET) + (RegOffset))
#define DMA_CONTROLLER_mReadSlaveReg9(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (DMA_CONTROLLER_SLV_REG9_OFFSET) + (RegOffset))
#define DMA_CONTROLLER_mReadSlaveReg10(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (DMA_CONTROLLER_SLV_REG10_OFFSET) + (RegOffset))
#define DMA_CONTROLLER_mReadSlaveReg11(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (DMA_CONTROLLER_SLV_REG11_OFFSET) + (RegOffset))
#define DMA_CONTROLLER_mReadSlaveReg12(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (DMA_CONTROLLER_SLV_REG12_OFFSET) + (RegOffset))
#define DMA_CONTROLLER_mReadSlaveReg13(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (DMA_CONTROLLER_SLV_REG13_OFFSET) + (RegOffset))
#define DMA_CONTROLLER_mReadSlaveReg14(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (DMA_CONTROLLER_SLV_REG14_OFFSET) + (RegOffset))
...
#define TEST_AXI_LITE_USER_NUM_REG 15
