...
//		for (row = 0; row < ALIEN_HEIGHT; row++) {
//			u32 tempRow = getAlienPixel(row, col, 0, tempGuise, alienNumber);
//			for (col = 0; col < 32; col++) {
//				framePointer0[(position.y + row)*640 + (position.x+col+(alienNumber*32))] = (tempRow >> (31-col) & 0x1)? WHITE : BLACK;
//			}
//		}
//	}
//	for(alienNumber = 11; alienNumber < 22; alienNumber++) {
//		for (row = 0; row < ALIEN_HEIGHT; row++) {
//			u32 tempRow = getAlienPixel(row, col, 1, tempGuise, alienNumber);
//			for (col = 0; col < 32; col++) {
//				framePointer0[(position.y + row + ALIEN_HEIGHT + 10)*640 + (position.x+col+((alienNumber%11)*32))] = (tempRow >> (31-col) & 0x1)? WHITE : BLACK;
//			}
//		}
//	}
...
//			u32 tempRow = getAlienPixel(row, col, 1, tempGuise, alienNumber);
//			for (col = 0; col < 32; col++) {
//				framePointer0[(position.y + row + 2*(ALIEN_HEIGHT + 10))*640 + (position.x+col+((alienNumber%11)*32))] = (tempRow >> (31-col) & 0x1)? WHITE : BLACK;
//			}
//		}
//	}
//	for(alienNumber = 33; alienNumber < 44; alienNumber++) {
//		for (row = 0; row < ALIEN_HEIGHT; row++) {
//			u32 tempRow = getAlienPixel(row, col, 2, tempGuise, alienNumber);
//			for (col = 0; col < 32; col++) {
//				framePointer0[(position.y + row + 3*(ALIEN_HEIGHT + 10))*640 + (position.x+col+((alienNumber%11)*32))] = (tempRow >> (31-col) & 0x1)? WHITE : BLACK;
//			}
//		}
//	}
...
//			u32 tempRow = getAlienPixel(row, col, 2, tempGuise, alienNumber);
//			for (col = 0; col < 32; col++) {
//				framePointer0[(position.y + row + 4*(ALIEN_HEIGHT + 10))*640 + (position.x+col+((alienNumber%11)*32))] = (tempRow >> (31-col) & 0x1)? WHITE : BLACK;
//			}
//		}
//	}
	//updateAlienLocation();
